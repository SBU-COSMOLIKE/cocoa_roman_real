...
theory:
  emul_cosmic_shear:
    ...
    extra_args: 
      device: 'cuda'
      file:  ['./projects/roman_real/emulators/lcdm_nla_halofit_cosmic_shear_cnn/lcdm_hmcode2020_nobaryon_cs_CNN.pt']
      extra: ['./projects/roman_real/emulators/lcdm_nla_halofit_cosmic_shear_cnn/lcdm_hmcode2020_nobaryon_cs_CNN.h5']
