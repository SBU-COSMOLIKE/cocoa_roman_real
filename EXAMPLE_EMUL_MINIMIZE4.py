...
theory:
  emul_cosmic_shear:
    ...
    extra_args: 
      device: 'cuda'
      file:  ['./projects/roman_real/emulators/w0wa_nla_halofit_cosmic_shear_cnn/w0wa_hmcode2020_nobaryon_cs_CNN.pt']
      extra: ['./projects/roman_real/emulators/w0wa_nla_halofit_cosmic_shear_cnn/w0wa_hmcode2020_nobaryon_cs_CNN.h5']
